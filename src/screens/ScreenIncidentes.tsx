  ...
  return (
    <div className="flex min-h-full flex-col">
            ...
            <div className="space-y-1">
              ...
              <Combobox
                ...
                options={reportarMaquinas.map((m) => ({
                  value: String(m.ID),
                  // Serie e ID en la 2ª línea: ver la nota del mismo selector en ScreenIncidenteForm.
      ...
      <EdificioDialog
        ...
        nombre={verEdificio?.NombreEdificio_IN}
        codigo={verEdificio?.CodigoEdifcio_IN}
    ...
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 line-clamp-1 text-sm font-semibold leading-tight">
          ...
          <EdificioLink nombre={i.NombreEdificio_IN} onClick={onVerEdificio} />
      ...
      <CardContent className="space-y-2 p-3 pl-4">
        ...
        <div className="flex items-start gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            {/* Edificio subrayado → abre el modal con sus datos (paridad PowerApps). */}
            <EdificioLink
              nombre={i.NombreEdificio_IN}
              onClick={onVerEdificio}
              className="block max-w-full truncate text-left text-sm font-semibold leading-tight"
            />
