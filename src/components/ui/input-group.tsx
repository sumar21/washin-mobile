  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Focus state. ring-2 + offset para igualar el foco del Input plano del proyecto.
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        // El control interno no debe tener foco propio: el ring lo dibuja el InputGroup.
        // ring-offset-0 evita el halo del color de fondo (el Input base trae ring-offset-2).
